        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Generic = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Medicines",
                columns: new[] { "Id", "Description", "Dosage", "Generic", "Name" },
                values: new object[,]
                {
                    { 1, "Pain reliever and fever reducer", "500mg", "Acetaminophen", "Paracetamol" },
                    { 2, "Antibiotic", "250mg", "Amoxicillin", "Amoxicillin" },
                    { 3, "Anti-inflammatory", "400mg", "Ibuprofen", "Ibuprofen" },
                    { 4, "Diabetes medication", "500mg", "Metformin HCl", "Metformin" },
                    { 5, "Cholesterol lowering", "10mg", "Atorvastatin", "Atorvastatin" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "Brain and nervous system", "Neurology" },
                    { 3, "Bones and joints", "Orthopedics" },
                    { 4, "Children's health", "Pediatrics" },
                    { 5, "Skin conditions", "Dermatology" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "admin@healthcare.com", "System Admin", true, "$2a$11$examplefixedhashstring1234567890", "Admin" });
